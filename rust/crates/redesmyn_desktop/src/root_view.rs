...
use crate::task_filters::{CloseTaskFilters, OpenTaskFilters};
...
impl WorkspacePaneHost {
    fn new(
        ...
        let task_filters_search_input = cx.new(|cx| TextInput::new(cx).placeholder("Add filter…"));
        let mut subscriptions = Vec::new();
