...
impl ActiveSessionsByTask {
    ...
    pub(crate) fn insert(&mut self, task_id: TaskId, interface_mode: InterfaceMode, session_id: SessionId) {
        self.map
    ...
    pub(crate) fn remove(&mut self, task_id: TaskId, interface_mode: InterfaceMode, session_id: SessionId) {
