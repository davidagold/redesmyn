# T-8 Terminology + model alignment: “Agent program” (not “Harness”)
...
stacked_on:
branch:
  suggested: rn/harness-interface-v0/T-8-agent-terminology-base
```
...
- The task map reflects the intended ordering: Base (T-8) → revised T-1 → T-7 (AgentDriver) → T-2/T-3/T-4.
