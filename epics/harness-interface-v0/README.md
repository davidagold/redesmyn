...
- `epics/harness-interface-v0/tasks/T-13/README.md`: UI: surface external session id (thread/session) when available (copyable).
- `epics/harness-interface-v0/tasks/T-14/README.md`: Fix structured tmux log capture race (missing early events like `thread.started`).
