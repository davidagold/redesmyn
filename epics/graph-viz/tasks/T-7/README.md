...
rn:
  node:
    branch: rn/graph-viz/task-7-diagonal-bias
  parent: T-2
  after:
  - T-3
---

# T-7 (Bonus) Diagonal branch bias for a centered path

## Plan

When the user centers a specific branch/stack (centers + zooms it in the viewport), consider a “diagonal bias” layout:
...
- Optional/behind a toggle in v0: a centered-path view exists for a selected node/stack.
